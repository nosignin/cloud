...
public class CheckRecommendStockParamAspect {
    ...
    public void checkMinRise(RecommendStock recommendStock, boolean checkMinRise){
        if(checkMinRise){
            ...
            String recommendStockMinRiseStr = dictionaryService.getDictionaryValueByKeyWithException("RECOMMEND_STOCK_MIN_RISE");
    ...
    public void checkMaxRise(RecommendStock recommendStock, boolean checkMaxRise){
        if(checkMaxRise){
            BigDecimal rise = caculateRise(recommendStock);
            String recommendStockMaxRiseStr = dictionaryService.getDictionaryValueByKeyWithException("RECOMMEND_STOCK_MAX_RISE");
    ...
    public void checkMinPay(RecommendStock recommendStock, boolean checkMinPay){
        if(checkMinPay){
            ...
            String recommendStockMinPay = dictionaryService.getDictionaryValueByKeyWithException("RECOMMEND_STOCK_MIN_PAY");
    ...
    public void checkMaxPay(RecommendStock recommendStock, boolean checkMaxPay){
        if(checkMaxPay){
            Integer pay = recommendStock.getPay();
            String recommendStockMaxPay = dictionaryService.getDictionaryValueByKeyWithException("RECOMMEND_STOCK_MAX_PAY");
